...
for i in os.listdir(mainDir):
    if i not in excludeList and i[-5:] == "_v.py":
        ...
        #沙箱接口
        if tableName.lower() == "tuihuohuanhuo":
            urlpatterns.extend(
                [
        ...
        if tableName.lower() == "tousufankui":
            urlpatterns.extend(
                [
                    path(r'{}/shBatch'.format(tableName.lower()),
                         eval("{}_v.{}_shBatch".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "discussgonggaoxinxi":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "discusshuodongshangpin":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
        ...
        if tableName.lower() == "discussyonghushangpin":
            urlpatterns.extend(
                [
                    path(r'{}/security'.format(tableName.lower()),
                         eval("{}_v.{}_security".format(tableName.capitalize(), tableName.lower()))),
